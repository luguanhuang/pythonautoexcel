...
class sportMainWindow(Ui_MainWindow, QMainWindow):
    ...
    FROM PivotedComponentInfo;
        ...
        ws.page_margins.top = 28.35 * 2.5
        ws.page_margins.bottom = 28.35 * 1.78

        ws.oddHeader.left.text = "oddHeader left"
        ws.oddHeader.center.text = "oddHeader center"
        ws.oddHeader.right.text = "oddHeader right"
        # ws.oddHeader.left.size = 14
        # ws.oddHeader.left.font = "Tahoma,Bold"
        # ws.oddHeader.left.color = "CC3366"

        ws.oddFooter.left.text = 'oddFooter left'
        ws.oddFooter.center.text = 'oddFooter center'
        ws.oddFooter.right.text = 'oddFooter right'
